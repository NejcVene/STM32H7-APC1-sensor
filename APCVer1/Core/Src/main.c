...
uint8_t measurementData[ARRAY_LENGTH];
char sendBuffer[BUFFER_SIZE];
int has = 0;

uint8_t idleCmd[] = {0x42, 0x4D, 0xE4, 0x00, 0x00, 0x01, 0x73},
		startCmd[] = {0x42, 0x4D, 0xE4, 0x00, 0x01, 0x01, 0x74},
		getDataCmd[] = {0x42, 0x4D, 0xE2, 0x00, 0x00, 0x01, 0x71};
...
uint8_t data[] = {66, 77, 0, 60, 0, 11,	0, 16, 0, 18, 0, 13, 0, 19, 0, 21, 10, 14, 2, 197, 0, 100, 0, 20, 0, 20, 0, 20, 0, 21, 1,
                  ...
                  7, 221}; // example of what we should receive
...
/* Configure the peripherals common clocks */
  ...
  while (1)
  {
	 ...
	 // snprintf(sendBuffer, 256, "Testing %d\r\n", counter);
	 // HAL_UART_Transmit(&huart3, sendBuffer, strlen(sendBuffer), 1000);
	 // HAL_Delay(1000);
    /* USER CODE END WHILE */
